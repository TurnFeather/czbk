...
public class AllAcciProAnalyzeAction extends ActionSupport{
...
//	private SerAccidentEbi serAccidentEbi;
	...
	private  List<AllProAcciNumModel> lst =null;
	//private List<>
	...
	public String execute() throws Exception {
		  ...
		  lst=serAllAccidentEbi.serProAccident();
		  System.out.println("serAllAccidentEbi"+serAllAccidentEbi.serDetailAccident().size());
